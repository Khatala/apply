            ...
            <div class="col-md-10">
                <div class="container main-content">
                    ...
                    <div class="add-faculty-section">
                        ...
                        <a href="{{ route('faculties.add', $institution->id) }}" class="btn btn-dark mb-3">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('faculties.courses.indexby', ['institutionId' => $institution->id, 'facultyId' => $faculty->id]) }}" class="btn btn-dark mb-3">
