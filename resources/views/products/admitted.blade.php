...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="{{ url('/') }}" class="nav-item nav-link">Home</a>
                ...
                <a href="{{ url('/contact-us') }}" class="nav-item nav-link active">Admissions</a>
            </div>
            @guest
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Admitted Applicants</h1>
    ...
    <!-- Contact Start -->
        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
                @if ($admittedProducts->isNotEmpty())
                    @foreach ($admittedProducts as $product)
                        <tr>
                            ...
                            <td>{{ $product->institution->name ?? 'Unknown Institution' }}</td>
                        </tr>
                    @endforeach
                @else
                    <tr>
                        <td colspan="13">No admitted students yet.</td>
                    </tr>
                @endif
            </tbody>
        </table>
