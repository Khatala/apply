        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="container mt-5">
                    ...
                    <!-- Course Form -->
                    <form action="{{ route('faculties.courses.store', ['institution_id' => $institutionId, 'faculty_id' => $facultyId]) }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <a href="{{ route('faculties.courses.index', ['institutionId' => $institutionId, 'facultyId' => $facultyId]) }}" class="btn btn-secondary">Cancel</a>
                    </form>
