            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="{{ url('/application-form/' . $faculty->id) }}" class="dropdown-item">
                            {{ $faculty->name }}
                        </a>
                        @endforeach
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    ...
                    <img class="image-thumbnail border rounded-circle p-2 mx-auto mb-3"  width="50" src="{{ asset('uploads/institutions/'.$institution->image) }}" alt="Profile Picture">
                    @endif
