...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="#" class="nav-item nav-link active">Institution Login</a>
            <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                    <div class="dropdown-menu fade-down m-0">
                        <a href="#" class="dropdown-item">Admin Login</a>
                        <a href="#" class="dropdown-item">Institution Register</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Institution Login</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="login-box">
  <form action="{{ route('institutions.login.submit') }}" method="POST">
  @csrf
    <div class="user-box">
