...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        @auth
        Welcome,<a href="{{ route('dashboard') }}" class="nav-item nav-link">
                    {{ __(Auth::user()->name) }}
                </a>
        @endauth
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Apply</a>
                    <div class="dropdown-menu fade-down m-0">
                        @foreach($institutions as $institution)
                        <li>
                            <a class="dropdown-item" href="{{ route('institution.apply', $institution->id) }}">{{ $institution->name }}</a>
                        </li>
                        @endforeach
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <a class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft" onclick="window.location.href='{{ route('login') }}'">Login</a>
                                <a class="btn btn-light py-md-3 px-md-5 animated slideInRight" onclick="window.location.href='{{ route('register') }}'">Join Now</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="owl-carousel testimonial-carousel position-relative">
                    <div class="testimonial-item text-center">
                        <img class="border rounded-circle p-2 mx-auto mb-3" src="{{ asset('images/testimonial-1.jpg') }}" style="width: 80px; height: 80px;">
                        <h5 class="mb-0">Khatala Khang</h5>
                        <p>Software Engineer</p>
                        <div class="testimonial-text bg-light text-center p-4">
                            <p class="mb-0">Learning to write programs stretches your mind, and helps you think better, creates a way of thinking about things that I think is helpful in all domains.</p>
                        </div>
                    </div>
                    <div class="testimonial-item text-center">
                        <img class="border rounded-circle p-2 mx-auto mb-3" src="{{ asset('images/testimonial-2.jpg') }}" style="width: 80px; height: 80px;">
                        <h5 class="mb-0">Thabiso Phenithi</h5>
                        <p>Developer</p>
                        <div class="testimonial-text bg-light text-center p-4">
                            <p class="mb-0">Debugging is twice as hard as writing the code in the first place. Therefore, if you write the code as cleverly as possible, you are, by definition, not smart enough to debug it.</p>
                        </div>
                    </div>
                    <div class="testimonial-item text-center">
                        <img class="border rounded-circle p-2 mx-auto mb-3" src="{{ asset('images/testimonial-3.jpg') }}" style="width: 80px; height: 80px;">
                        <h5 class="mb-0">Majane Sehlabaka</h5>
                        <p>Graphic Designer</p>
                        <div class="testimonial-text bg-light text-center p-4">
                            <p class="mb-0">The more I deal with the work as something that is my own, as something that is personal, the more successful it is.</p>
                        </div>
                    </div>
                    <div class="testimonial-item text-center">
                        <img class="border rounded-circle p-2 mx-auto mb-3" src="{{ asset('images/testimonial-4.jpg') }}" style="width: 80px; height: 80px;">
                        <h5 class="mb-0">M'alineo Manasse</h5>
                        <p>Cinematographer</p>
                        <div class="testimonial-text bg-light text-center p-4">
                            <p class="mb-0">Forget the camera. The nature of the story determines the photographic style. Understand the story and make the most out of it. If the audience is conscious of tricks and effects, the cameraman’s genius, no matter how great it is, is wasted.</p>
                        </div>
                    </div>
                </div>
            </div>
